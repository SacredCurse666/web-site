...
<head>
	...
	<title>Админка | ShopOnline</title>
	...
	<header class="text-gray-700 body-font">
            <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
              ...
              <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
				...
				<a id="manageDeliveriesBtn" href="../cart.html" class="mr-5 hover:text-gray-900 text-3xl">Управление доставкой</a>
				<a id="manageProductsBtn" href="adminProductManage.php" class="mr-5 hover:text-gray-900 text-3xl">Управление продуктами</a>
			  </nav>
			  <br>
			  <br>
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
					...
					<br>	
					<div class="col-sm-10">
						<a href="#addProductModal" class="btn btn-success" data-toggle="modal"><i class="material-icons"></i> <span>Добавить новый товар</span></a>
					</div>
					<br>
					<br>
					<br>

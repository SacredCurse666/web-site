...
<head>
	...
	<title>Ваш заказ | ShopOnline</title>
...
<body>
	...
	<header class="text-gray-700 body-font">
            <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
              ...
              <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
                ...
                <a id="viewProdBtn" class="mr-5 hover:text-gray-900 text-3xl" href="customerProductView.php">Продукты</a>
                <form action="customerCart.php" method="POST">
                    <input type="hidden" id="emailText" name="email" value="">
                    <button type="submit" id="viewCartBtn" class="mr-5 hover:text-gray-900 text-3xl">Корзина</button>
                </form> 
                
                <form action="yourOrders.php" method="POST">
                    <input type="hidden" id="emailTextTwo" name="email" value="">
                    <button type="submit" id="viewOrdersBtn" class="mr-5 hover:text-gray-900 text-3xl">Заказ</button>
                </form> 
                <br>
			  </nav>
			  <br>
    ...
    <div class="container">
	<p id="success"></p>
	<h3 class="text-right" id="welcomeMsg">Привет, </h3>
	<script>
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Ваш<b> заказ</b></h2>
						<h5><b>Note:</b> Информацию о заказе можно просмотреть в указаной вами почте</h5>
					</div>
            ...
            <table class="table table-striped table-hover">
				...
				<tr>
                    ...
                    <td><button type="submit" class="btn btn-primary">Детали</button></td>
                    </form>
                    <form action="backend/cancelOrder.php" method="POST">
                        <input type="hidden" name="cancelOrderID" value="<?php echo $row["deliveryID"] ; ?>">
                        <input type="hidden" name="email" value="<?php echo $email ; ?>">
                    <td><button type="submit" class="btn btn-danger">Отмена</button></td>
                    </form>

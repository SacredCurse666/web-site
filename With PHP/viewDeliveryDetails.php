...
<head>
	...
	<title>Детали доставки | ShopOnline</title>
	...
	<p id="success"></p>
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2><b>Детали</b> заказа : Delivery ID: <?php echo $deliveryIDforModal ?></h2>
					</div>
					<br>
...
<br><br><br>
 <div class="text-center">
 	<form action="yourOrders.php" method="POST">
            ...
            <button type="submit" class="btn btn-primary">В ваши заказы</button>
    </form>
 </div>

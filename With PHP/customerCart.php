...
<meta charset="utf-8">
	...
	<title>Ваша корзина | ShopOnline</title>
            ...
            <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
              ...
              <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
                ...
                <form action="yourOrders.php" method="POST">
                    ...
                    <button type="submit" id="viewOrdersBtn" class="mr-5 hover:text-gray-900 text-3xl">Заказы</button>
                </form> 
                <br>
			  </nav>
			  <br>
...
<button type="submit" class="button"><span>Совершить заказ </span></button>
</form>
</div>
<br>
...
<button type="submit" class="button"><span> Очистить корзину</span></button>
</form>
</div>
<br><br>
